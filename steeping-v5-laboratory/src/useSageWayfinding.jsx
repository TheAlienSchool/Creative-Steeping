...
const STEEP_REFLECTIONS = {
  ...
  mirror: [
    ...
    "Reflection is witnessing. The space holds it.",
    "The stillness after expression is where the flavor develops.",
  ],
  labyrinth: [
    "You are deep in the winding. Complexity is the path.",
  ...
  conclave: [
    ...
    "Each return steeps differently. The water remembers who you were.",
    "Your archive carries forward. The words you left here are still composting.",
    "The practice deepens by return.",
  ],
  crown: [
    "Something has crystallized. You can feel it in the stillness.",
    "The long steep is trust. It arrives when it is ready.",
...
const INTENT_RESPONSES = {
  arrival: [
    "You are already here. The arrival is the act.",
    "This is a space for presence. Everything you arrived with is welcome.",
    "The practice begins the moment you pause. You have already begun.",
    "Attention is the only entry. You are already through the door.",
  ],
  resistance: [
    "Uncertainty is part of the territory. You are in the right place.",
    "The uncertain place is where the practice deepens. Stay.",
    "Confusion is often the feeling of something rearranging. Let it.",
    "Move with the question. The answer has its own timing.",
  ],
  seeking: [
    "What draws you here may arrive before its name does. The search is the work.",
    "Seeking is attention in motion. Follow what is pulling you.",
  ...
  inquiry: [
    "The question itself is where you are. Let it open.",
    "Ask it again. Listen to what the question reveals.",
    "Some questions are answered by living with them. Time does the work.",
    "You are naming something. That naming is its own kind of arrival.",
  ],
  affirmation: [
    "What you named just shifted something. Stay with it.",
    "That observation is the practice. You are already in it.",
  ...
  practice: [
    "The practice deepens what is already happening. More presence, same ground.",
    "The next movement is a deepening. More of where you already are.",
    "What becomes possible when you give this more time?",
    "Attention is the technique. Everything else follows from that.",
  ],
};
