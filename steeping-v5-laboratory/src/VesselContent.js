...
export const VESSELS = [
    ...
    },
    {
        ...
        body: "Something knows before you do. Before the first word arrives, before the right story surfaces — there is an essence that has always been present. Creative Steeping begins by returning to that ground. It is a self-narration prerogative: the assertion of your right to hear your own voice and trust the wisdom it carries. This first steep asks you to locate what remains when every assigned label has been removed. That remainder is yours. It has always been.",
        reflection: [
    ...
    },
    {
        ...
        interaction: {
            prompt: "Write down the first limiting belief you see reflected in the water, then cross it out.",
    ...
    },
    {
        ...
        body: "You arrived as a visitor. You leave as the author. Every vessel you entered, every reflection you sat with, every interaction you completed — that is the work. The practice does not end here. It has a signature now. This steep asks you to place it.",
        reflection: [
