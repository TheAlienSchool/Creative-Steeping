...
const QUANTUM_INQUIRIES = [
    ...
    "Before stepping into the expanse, what heavy artifact are you ready to bury here?",
    ...
    "What rigid version of your ego will you ignite, clearing space for the real journey to begin?",
