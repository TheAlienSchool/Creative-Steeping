...
export function Vessel07Detail({ modeString, playAlgoraveSynth, playStrikingBowl, playCompletionCue }) {
    ...
    return (
        <div style={{ marginTop: 'var(--space-xxl)', marginBottom: 'var(--space-xl)', textAlign: 'center' }}>
            ...
            <div style={{
                position: 'relative', padding: 'var(--space-xl)', background: activated ? m.bg : 'rgba(0,0,0,0.5)',
                ...
                width: '100%', maxWidth: '700px', margin: '0 auto', boxShadow: activated ? `0 0 40px ${m.accent}` : 'none'
            }}>
                ...
                {!activated ? (
                    <>
                        <textarea
                            ...
                            style={{
                                ...
                                color: m.accent, fontFamily: 'var(--fSerif)', fontStyle: 'italic', fontSize: '2rem',
                    ...
                    <div style={{ animation: 'floatUp 1.8s cubic-bezier(0.16, 1, 0.3, 1)', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                        <div style={{ fontFamily: 'var(--fSerif)', fontSize: '2.5rem', color: m.text1, fontStyle: 'italic', marginBottom: '2rem', lineHeight: 1.4 }}>
