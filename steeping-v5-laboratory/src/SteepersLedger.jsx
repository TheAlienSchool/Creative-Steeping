...
const SAGE_CONTEXT = {
    ...
    pause:       { series: 'ARCHITECTURE', freq: 65, kicker: 'The Structure of Stillness', sage: 'The Pause is the most load-bearing pillar of any endeavor. Awareness Planning maps the sanctuary of restraint. Key concepts: Pause, Awareness Planning, a•i•Contemplation, Architecture.' },
    ...
    'three-states':    { series: 'TYPOGRAPHY', freq: 102, kicker: 'Three States. One Word.', sage: 'Every word in the instrument holds three simultaneous states (HARRIS, HBA, VAPOR). The reader\'s coordinate determines the state. The word remains the anchor; the state shifts around it. This is the foundation of Spacetime Linguistics.' }
};
